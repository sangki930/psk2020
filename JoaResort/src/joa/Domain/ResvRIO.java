...
public class ResvRIO {
	...
	String telnum;//연락처
	String in_name;//입금자명
	public ResvRIO(String name, LocalDate resv_date, int room, String addr, String telnum, String in_name,
	...
	public ResvRIO(String name, LocalDate resv_date, int room, String addr, String telnum, String in_name, String comment,
