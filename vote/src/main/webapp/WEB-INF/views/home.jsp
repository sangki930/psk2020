...
System.out.println("총 레코드 수 : "+sa.getList().size());

for(int i=0;i<sa.getList().size();i++)//커서를 한 줄 씩 내림
{
out.println("<tr><td><form method=\"post\" action=\"./A_02\">");//POST 방식으로 A_02.jsp(삭제)으로 이동
...
%>
<tr><td><form method="post" action="./A_03">
