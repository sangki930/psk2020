...
ReviewSIO gs= new ReviewSIO();
	gs=g.selectOne(id);
	g.viewcnt_update(id);//조회수 업데이트
	
	System.out.println("rootid="+gs.getRootid());
	System.out.println(gs.getRelevel());
	System.out.println(gs.getRecnt());
	
%>
 <input type=hidden name="from" value="<%=from%>">
 <input type=hidden name="id" value="<%=id%>">
 <input type=hidden name="rootid" value="<%=gs.getRootid()%>">
<input type=hidden name="relevel" value="<%=gs.getRelevel()%>">
<input type=hidden name="recnt" value="<%=gs.getRecnt()%>">
<input type=hidden  class="form-control" name=title size=70 maxlength=70 value=<%=gs.getTitle()%>>
...
<tr>
	...
	<td bgcolor=white><%=gs.getDate()%></td>
</tr>
<tr>
	<td class="skycolor"><b>파일</b></td>
	<td bgcolor=white><a href="Filedownload.jsp?filename=<%=gs.getFilename()%>"><%=gs.getFilename()%></a></td>
</tr>
<tr>
	<td class="skycolor"><b>조회수</b></td>
	<td bgcolor=white><%=gs.getViewcnt()%></td>
</tr>
<tr>
	<td class="skycolor"><b>내용</b></td>
	<td bgcolor=white><textarea class="form-control" rows="3" readonly>
	<%=gs.getContent()%>
	</textarea>
	</td>
...
<tr>
	...
	<input type=button value="답글" OnClick="submitForm('reply')">
	</td>
</tr>
