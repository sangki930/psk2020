...
.btn-box .room_btn{/*btn-box 클래스와 button 조건을 만족하면*/
...
.btn-box .room_btn:hover .fa{/*해당 아이콘에 커서를 올려놓았을 때*/
	color : #ff7846;/* 색 설정*/
}
  			...
  			<div class="main">
  					<div id="hero"><!-- hero에 들어갈 id 지정 -->
						<div class="btn-box"><!-- 버튼 박스 구역 -->
							<button id="btn1" class="room_btn" onclick="openVIP()"><i class="fa fa-html5"></i>VIP룸</button>
							<button id="btn2" class="room_btn" onclick="openNormal()"><i class="fa fa-css3"></i>일반룸</button>
							<button id="btn3" class="room_btn" onclick="openLite()"><i class="fa fa-codepen"></i>합리적인 룸</button>
						</div><!-- 버튼 박스 구역 끝 -->
