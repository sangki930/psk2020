...
public class ReviewPage { //PageNation
	...
	public ReviewPage(int startpage, int presentpage, int endpage) {
		super();
		this.startpage = startpage;
		this.presentpage = presentpage;
		this.endpage = endpage;
	...
	public ReviewPage(int from, int cnt) {
		//from�� �� ������, cnt�� ������ ��Ÿ���� ����
		...
		this.totalpage=(ReviewRepo.getAllRecords().size()/cnt)+1;//��� Record��
