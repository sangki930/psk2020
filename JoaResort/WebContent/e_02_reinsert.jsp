...
if(request.getParameter("rootid")!=null){
	...
	System.out.println("rootid 값이 넘어왔습니다. 그값은"+rootid);
}
int relevel=0;
...
int recnt=0;
if(request.getParameter("recnt")!=null){
...
%>
 ...
 <input type=hidden name="rootid" value='<%=rootid%>'>
	<input type=hidden name="relevel" value='<%=relevel+1%>'>
...
<tr>
	...
	<td bgcolor=white>신규 댓글(reply)<input type=hidden name="id" value=2></td>
</tr>
<tr>
